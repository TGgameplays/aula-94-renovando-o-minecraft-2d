...
//Adicionar um eventListener e chamat função keydown//
//O evento keydown significa que, sempre que uma tecla for pressionada, esse
//evento será executado e chamará a função my_keydown
//(minha_teclapressionada), uma função que já definimos.
...
//Definir a função my_keydown
function my_keydown(e) {
    keyPressed = e.keyCode;
    console.log(keyPressed);


    //Verificar valores das teclas na tabela ASCII
    ...
    //Aqui não  utilizaremos o comando shift portanto não precisamos do e.shiftKey
    //Construir o if com a função keyPressed e o código ASCII
    if (keyPressed == '38') {
        up();
        console.log("cima");
    }
